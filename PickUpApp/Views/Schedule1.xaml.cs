...
namespace PickUpApp
{	
	public partial class Schedule1 : ContentPage
	{	
		public Schedule1 (Schedule selectedSchedule)
		{
			InitializeComponent ();
			this.ViewModel = new Schedule1ViewModel (App.client, selectedSchedule);
			this.Padding = new Thickness(10, Device.OnPlatform(20, 0, 0), 10, 5);

			btnNext.Clicked += HandleClicked;
			btnCancel.Clicked += HandleCancel;

			MessagingCenter.Subscribe<Schedule> (this, "LocationUpdated", (s) => {
				ViewModel.Refresh();
		...
		void HandleClicked (object sender, EventArgs e)
		{
			...
			Navigation.PushModalAsync (new Schedule2 (ViewModel.CurrentSchedule, ViewModel.Kids, ViewModel.KidSchedules));
		}

		protected Schedule1ViewModel ViewModel
		{
			get { return this.BindingContext as Schedule1ViewModel; }
