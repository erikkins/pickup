...
namespace PullToRefreshAndroidFormsAndroid
{
	...
	SwipeRefreshLayout.IOnRefreshListener
	{
		...
		public PullToRefreshAndroidForms.PullToRefreshListView RefreshView
		{
			get { return this.Element == null ? null : (PullToRefreshAndroidForms.PullToRefreshListView)Element; }
		}
		...
		{
			if (e.PropertyName == PullToRefreshAndroidForms.PullToRefreshListView.IsRefreshingProperty.PropertyName) {
